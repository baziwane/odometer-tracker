...
// Base car object schema without refinements
...
// Full car schema with validation
export const carSchema = carBaseSchema.refine(
  (data) => {
...
// Update schema - partial without refinement (for PATCH operations)
